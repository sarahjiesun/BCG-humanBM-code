...
auc_mat <- read.csv(file=paste0("scenic_cluster_CMP_b_auc_mtx.csv"))
...
write.csv(wilcox_data, file=paste0(OUT_DIR, "CMP_b_wilcox_data_no_outliers.csv")) ##RENAME CMP c2
