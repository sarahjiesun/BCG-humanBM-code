...
#Analysis excluding S2
auc_mat <- read.csv(file=paste0("scenic_cluster_MLP_b_auc_mtx.csv"))
...
write.csv(wilcox_data, file=paste0(OUT_DIR, "MLP_b_wilcox_data_no_outliers.csv")) ##RENAME MLP c2