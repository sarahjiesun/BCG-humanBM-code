...
auc_mat <- read.csv(file=paste0("scenic_cluster_MEP_b_auc_mtx.csv"))
...
write.csv(wilcox_data, file=paste0(OUT_DIR, "MEP_b_wilcox_data_no_outliers.csv")) ##RENAME MEP c2
