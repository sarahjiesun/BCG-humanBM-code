...
auc_mat <- read.csv(file=paste0("scenic_cluster_MEP_a_auc_mtx.csv"))
...
write.csv(wilcox_data, file=paste0(OUT_DIR, "MEP_a_wilcox_data_no_outliers.csv")) ##RENAME MEP c1
