...
scv.pl.velocity_embedding_stream(adata, basis="umap", legend_fontsize=12, title="S5_Td0 Velocity Plot", smooth=0.8, min_mass=4, color="Cluster_colors", save="S5_Td0_velocity_plot.png")
...
g.plot_terminal_states(discrete="TRUE", title="S5_Td0 Terminal states", save="S5_Td0_terminal_states.png")
...
trans_probs.to_csv('S5_Td0_to_terminal_states.csv')
