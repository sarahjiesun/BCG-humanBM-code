...
sample_obs = pd.read_csv("cellID_obs_S18_Td0.csv")
umap_cord = pd.read_csv("cell_embeddings_S18_Td0.csv")
cell_clusters = pd.read_csv("clusters_S18_Td0.csv")
...
scv.pl.velocity_embedding_stream(adata, basis="umap", legend_fontsize=12, title="S18_Td0 Velocity Plot", smooth=0.8, min_mass=4, color="Cluster_colors", save="S18_Td0_velocity_plot.png")
...
vu.to_csv('S18_Td0_velocity_umap_coords.csv')
...
g.plot_terminal_states(discrete="TRUE", title="S18_Td0 Terminal states", save="S18_Td0_terminal_states.png")
...
trans_probs.to_csv('S18_Td0_to_terminal_states.csv')
