...
sample_obs = pd.read_csv("cellID_obs_S20_Tm3.csv")
umap_cord = pd.read_csv("cell_embeddings_S20_Tm3.csv")
cell_clusters = pd.read_csv("clusters_S20_Tm3.csv")
...
scv.pl.velocity_embedding_stream(adata, basis="umap", legend_fontsize=12, title="S20_Tm3 Velocity Plot", smooth=0.8, min_mass=4, color="Cluster_colors", save="S20_Tm3_velocity_plot.png")
...
vu.to_csv('S20_Tm3_velocity_umap_coords.csv')
...
g.plot_terminal_states(discrete="TRUE", title="S20_Tm3 Terminal states", save="S20_Tm3_terminal_states.png")
...
trans_probs.to_csv('S20_Tm3_to_terminal_states.csv')
