...
adata = anndata.read_loom("/project2/lbarreiro/users/Sarah/HUMAN_BM_PROJECT/BM_CD34_scRNA/capture11_output/velocyto/capture11_output.loom")
sample_obs = pd.read_csv("cellID_obs_S12_Td0.csv")
umap_cord = pd.read_csv("cell_embeddings_S12_Td0.csv")
cell_clusters = pd.read_csv("clusters_S12_Td0.csv")
...
scv.pl.velocity_embedding_stream(adata, basis="umap", legend_fontsize=12, title="S12_Td0 Velocity Plot", smooth=0.8, min_mass=4, color="Cluster_colors", save="S12_Td0_velocity_plot.png")
...
vu.to_csv('S12_Td0_velocity_umap_coords.csv')
...
g.plot_terminal_states(discrete="TRUE", title="S12_Td0 Terminal states", save="S12_Td0_terminal_states.png")
...
trans_probs.to_csv('S12_Td0_to_terminal_states.csv')
